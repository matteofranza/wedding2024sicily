...
if language_selection == "ITA":
    ...
    <b>Villa Fegotto:</b> sarà la sede del nostro sposalizio. [Qui](https://www.youtube.com/watch?v=NWwEc5bUbDo) potete cominciare a farvi un'idea del posto. Se siete interessati alla storia della villa, potete farvela raccontare direttamente da quel figo di Alberto Angela [qui](https://www.facebook.com/SquiseatingVillaFegotto/videos/villa-fegotto-a-ulisse-il-piacere-della-scoperta/770288190120868/). Come avrete capito, Villa Fegotto non è vicinissima a Ragusa ma dista circa 30 minuti. Non preoccupatevi, data la distanza e l’open bar, vi metteremo a disposizione un servizio di bus gratuito per l'evento (vedi sezione Wedding day).<br>
