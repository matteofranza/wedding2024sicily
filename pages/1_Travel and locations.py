...
if language_selection == "ITA":
    ...
    <br>            
    <b>Villa Fegotto:</b> sarà la sede del nostro sposalizio. <a href='https://www.youtube.com/watch?v=NWwEc5bUbDo'>Qui</a> potete cominciare a farvi un'idea del posto. Se siete interessati alla storia della villa, potete farvela raccontare direttamente da quel figo di Alberto Angela <a href='https://www.facebook.com/SquiseatingVillaFegotto/videos/villa-fegotto-a-ulisse-il-piacere-della-scoperta/770288190120868/'>qui</a>. Come avrete capito, Villa Fegotto non è vicinissima a Ragusa ma dista circa 30 minuti. Non preoccupatevi, data la distanza e l’open bar, vi metteremo a disposizione un servizio di bus gratuito per l'evento (vedi sezione Wedding day).<br>
    <br>            
...
if language_selection == "ENG":
    ...
    For those who will land in Catania, if you don’t want to rent a car, you can use the bus service [Etnatraporti](https://www.etnatrasporti.it/) that, with a picturesque journey among prickly pear, dry stone walls and trash, will take you to Ragusa and Marina di Ragusa. Tickets are purchasable online or at the ticket kiosk right outside the airport (Kiosk Etnatrasporti).
    There are buses to Ragusa at every hour of the day (Travel time: 1h45). Nonetheless, buses from the airport to Marina di Ragusa are more infrequent (4 rides/day, travel time: 2h20), so check in advance online or at the ticket kiosk if and which buses are directed to Marina di Ragusa. In any case, there is a bus departing Ragusa <a href='https://tuminobus.it/linea/?race=1'>bus</a> station to Marina di Ragusa at every hour. <br>
    ...
    <b>Villa Fegotto:</b> it’s the place where the ceremony and the party will take place. [Here](https://www.youtube.com/watch?v=NWwEc5bUbDo) you can find some information about the place. If you’re interested about the history of the Villa, [here](https://www.facebook.com/SquiseatingVillaFegotto/videos/villa-fegotto-a-ulisse-il-piacere-della-scoperta/770288190120868/) you have that handsome man Alberto Angela telling you the story. As you might have noticed, Villa Fegotto isn’t very close to Ragusa, but it’s 30 min far away. Don’t worry, given the distance and the open bar, there will be a bus service available for you for the day (see Wedding day section).<br>
    </div>
    """, unsafe_allow_html=True)
