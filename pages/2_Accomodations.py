...
if language_selection == "ITA":
    st.markdown("""
                ...
                Le piattaforme di prenotazione consigliate sono quelle classiche (AirBnB, Booking, campeggio), più i vari Hotel presenti sul posto.<br> 
...
if language_selection == "ENG":
    st.markdown("""
                ...
                The platforms for bookings that we suggest are the classic ones (AirBnB, Booking, Camping), plus the various hotels.<br>
